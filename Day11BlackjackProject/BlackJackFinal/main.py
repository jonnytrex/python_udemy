...
def calculate_score(cards):
  """Take a list of cards and return the score calculated from each hand"""
...
#  print("Blackjack!")
#  user_score = 0
#if calculate_score(computer_cards) == 21 and len(computer_cards) == 2:
#  print("Blackjack!")
#  score = 0
  #for _card in range(2):
  #  if user_cards[_card] == 11 and sum(cards) > 21:
  #    user_cards.remove(_card)
  #    user_cards.append(1)
